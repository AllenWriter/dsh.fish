...
export function kitchenSinkReadme(): string {
  return [
    ...
    '',
    '| Setting | Staging DSN | Production DSN |',
    '| --- | --- | --- |',
    '| Primary | `postgresql://readonly:super-secret-password@staging.internal.example.com:5432/analytics?sslmode=require&application_name=dsh-postgres-mcp` | `postgresql://readonly:super-secret-password@prod.internal.example.com:5432/analytics?sslmode=require&application_name=dsh-postgres-mcp` |',
    '| Replica | `postgresql://readonly:super-secret-password@staging-replica.internal.example.com:5432/analytics?sslmode=require` | `postgresql://readonly:super-secret-password@prod-replica.internal.example.com:5432/analytics?sslmode=require` |',
    '',
    '## Install',
    '',
    '```sh',
