...
The collection schema and `readBlogPage` both require the field. Listings crop that 3:5 poster into a 4:3 tile (`object-cover` at the optical center). The listing
