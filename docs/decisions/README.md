...
- [`adr-0005-product-docs-with-fumadocs.md`](adr-0005-product-docs-with-fumadocs.md) — grow `/docs` into a section; adopt Fumadocs (`core` + `mdx`, custom shell) for that section only. Accepted; the engine is superseded — docs are static Markdown served like the blog.
...
- [`adr-0007-editorial-blog.md`](adr-0007-editorial-blog.md) — `/blog` as dated series with a custom shell, not a docs sidebar. Accepted; bodies are static Markdown files rather than a Fumadocs collection.
