...
import { TextScramble } from "@/shared/ui/motion/text-scramble";
import { EASE_OUT, SPRING_SWAP } from "@/shared/lib/ease";
import {
  TEXT_SHIMMER_CLASS_NAME,
  TEXT_SHIMMER_KEYFRAMES,
  textShimmerStyle,
} from "@/shared/lib/text-shimmer";
...
export function ReasoningText({
  ...
  const phrase = safePhrases[index % safePhrases.length] ?? DEFAULT_PHRASES[0] ?? "Thinking";
