...
import type { BlogPostCard, BlogTocItem } from '../model/types'
...
export function BlogArticle({
  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl justify-center gap-10 px-6 py-10 lg:py-14">
      <article className="min-w-0 w-full max-w-3xl">
        ...
        <div className="mt-8 pb-8 text-[15px] leading-7 text-foreground/90 [&_p]:[overflow-wrap:anywhere] [&_li]:[overflow-wrap:anywhere]">
          {children}
        </div>
