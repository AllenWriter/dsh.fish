...
description: "不装宝塔，用 Vercel 加一台 VPS 搭 Clash 订阅转换前端。"
---

> **tip**
> 如果你想直接使用 Clash 转码平台，不想知道这里的门道，可以自己按下文把转换前端部署起来。

## [前言](#preface)

网上有太多使用复杂的宝塔面板进行搭建 Clash 前端的教程，但它们基本都是要求通过宝塔面板来进行搭建。但是，这样的教程对于新手来说，虽然可以跟着走，但是依然不够「快」。如果你还不知道何为 Clash，那么请阅读[《什么是 Clash？》](/docs/what-is-clash)
